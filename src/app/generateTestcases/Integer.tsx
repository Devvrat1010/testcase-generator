...
export default function Integer({ k, setCurr, curr }: { k: number, setCurr: React.Dispatch<React.SetStateAction<VariableData | undefined>>, curr: VariableData}): React.JSX.Element {
    return (
        <div className="flex flex-col justify-between gap-4 items-center">
            <div>
                ...
                <div className="flex gap-2 items-center [&>*]:w-1/2 [&>*]:p-1 [&>*]:h-fit">
                    <Input type="integer" id="integer" placeholder="start" onChange={
                        (e) => {
                            setCurr({ ...curr, varData: { ...curr.varData, range: [Number(e.target.value), curr.varData.range[1]] } });
                        }
                    } />
                    -
                    <Input type="integer" id="intEnd" placeholder="end" onChange={
                        (e) => {
            ...
            <div>
                ...
                <Input className="w-full" type="string" id="intValues" placeholder="Integer" onChange={
                    (e) => {
                        ...
                        setCurr({ datatype: "integer", varData: { range: [], specificValues: values } });
                    }
                } />
            </div>
        </div>
